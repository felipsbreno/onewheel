      ...
      <div className="mx-auto w-full max-w-md px-8">
        ...
        >
          <Form method="post" className="space-y-6">
            ...
            <button
              type="submit"
              className="w-full rounded bg-yellow-500  py-2 px-4 text-white hover:bg-yellow-600 focus:bg-yellow-600"
            >
              Entrar
            </button>
            <div className="flex items-center justify-between">
              <div className="flex items-center">
                <input
                  ...
                  name="remember"
                  type="checkbox"
                  className="h-4 w-4 rounded border-gray-300 text-blue-600 outline-none focus:ring-blue-500"
                />
                <label
                  htmlFor="remember"
